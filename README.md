...
3.  ***Click [`FORK`](ahmadtech12/ahmad_md/fork) and `Star ⭐ Repository` for Courage.***
4.  ***Deploy FREE on `Codespace,` First watch tutorial [`Codespace tutorial`](https://youtu.be/3NdJb6_1cJM)***
5.  ***Deploy on [`HEROKU`](https://heroku.com/deploy?template=ahmadtech12/ahmad_md).  `FIXED! ✔️`***
